...
<h2>Esta política de condiciones de uso es válida a partir del Jul 2023.</h2>
<h3>TÉRMINOS Y CONDICIONES — Kool Frenzy</h3>
</div>
<div class="card p-4">
<p><b>Kool Frenzy</b>, persona jurídica de derecho privado describe, a través de este documento, las normas de uso del sitio <a class="italic" href="#">//kool-frenzy.com</a> y de cualquier otro sitio web, tienda o aplicación operada por el titular.

Al navegar por este sitio web, consideramos que está de acuerdo con las condiciones de uso que figuran a continuación.</p>

<p>Si no está de acuerdo con los términos de este acuerdo, le pedimos que no haga ningún otro uso de este sitio web, mucho menos que se registre o envíe sus datos personales.
...
<li><b>Sección 1 - Usuario</b></br>
El uso de este sitio web le otorga automáticamente la condición de Usuario e implica su plena aceptación de todas las directrices y condiciones incluidas en estas Condiciones.</li>

<li><b>Sección 2 - Adhesión junto con la política de privacidad</b></br>
El uso de este sitio web implica la adhesión a estas Condiciones de Uso y a la versión más actualizada de la Política de Privacidad de Kool Frenzy.</li>

<li><b>Sección 3 - Condiciones de acceso</b></br>
En general, el acceso al sitio web de Kool Frenzy es gratuito y no requiere registro previo.
...
Algunas partes de este sitio web ofrecen al usuario la opción de publicar comentarios en determinadas áreas.Kool Frenzy no consiente la publicación de contenidos de carácter discriminatorio, ofensivo o ilícito, o que infrinjan los derechos de autor o cualquier otro derecho de terceros.

La publicación de cualquier contenido por parte del usuario de este sitio web, incluidos los mensajes y comentarios, implica una licencia no exclusiva, irrevocable e irreversible para su uso, reproducción y publicación por parte de Kool Frenzy en su sitio web, plataformas de internet y aplicaciones, o incluso en otras plataformas, sin ninguna restricción o limitación.
</li> 

<li>
<b>Sección 4 - Cookies</b></br>
...
<li>
<b>Sección 5 - Propiedad intelectual</b></br>
Todos los elementos de Kool Frenzy son propiedad intelectual de la misma o de sus licenciantes. Estos términos o el uso del sitio web no le otorgan ninguna licencia o derecho de uso de los derechos de propiedad intelectual de Kool Frenzy o de cualquier tercero.
</li>

<li>
<b>Sección 6 - Enlaces a sitios web de terceros</b></br>
...
<li>
<b>Sección 7 - Plazos y modificaciones</b></br>
El funcionamiento de este sitio web es por tiempo indefinido.

La totalidad del sitio web o cada una de sus secciones podrá ser cerrada, suspendida o interrumpida unilateralmente por Kool Frenzy, en cualquier momento y sin previo aviso.
</li>

<li>
<b>Sección 8 - Datos personales</b></br>
Durante el uso de este sitio web, ciertos datos personales serán recogidos y procesados por Kool Frenzy y/o los Socios. Las normas relativas al tratamiento de los datos personales de Kool Frenzy están estipuladas en la Política de Privacidad.
</li>

<li>
<b>Sección 9 - Contacto</b></br>
Si tiene alguna pregunta sobre las condiciones de uso, por favor póngase en contacto con nosotros por correo electrónico <b>eduardo.arede@gmail.com.</b>
</li>
</ul> 
</div> 
<div class="btn-q mt-20 mb-20">
 <a href="{{ route('contact') }}" class="btn bg-indigo-900 text-light hover:bg-indigo-600"><i class="fa-regular fa-circle-question me-3"></i>¿Preguntas?... Podemos responderlas</a>
</div>      
</div>
</x-app-layout>