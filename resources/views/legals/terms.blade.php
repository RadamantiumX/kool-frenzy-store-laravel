...
<x-app-layout>
    <div>
        <p>
        Esta política de condiciones de uso es válida a partir del Jul 2023.
TÉRMINOS Y CONDICIONES — Kool Frenzy

Kool Frenzy, persona jurídica de derecho privado describe, a través de este documento, las normas de uso del sitio https://kool-frenzy.com y de cualquier otro sitio web, tienda o aplicación operada por el titular.
...
El uso de este sitio web después de los cambios significa que usted acepta las condiciones de uso revisadas. Si, después de leer la versión revisada, no está de acuerdo con sus términos, por favor, termine su acceso.
    ...
    El uso de este sitio web implica la adhesión a estas Condiciones de Uso y a la versión más actualizada de la Política de Privacidad de Kool Frenzy.
    ...
    Si tiene alguna pregunta sobre las condiciones de uso, por favor póngase en contacto con nosotros por correo electrónico eduardo.arede@gmail.com.
        </p>
    </div>
</x-app-layout>